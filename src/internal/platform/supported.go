...
func BuildModeSupported(compiler, buildmode, goos, goarch string) bool {
	...
	case "shared":
		switch platform {
		case "linux/386", "linux/amd64", "linux/arm", "linux/arm64", "linux/ppc64", "linux/ppc64le", "linux/s390x", "openharmony/arm64", "openharmony/amd64":
			return true
		}
		return false
...
func InternalLinkPIESupported(goos, goarch string) bool {
	...
	case "android/arm64",
		...
		"windows/386", "windows/amd64", "windows/arm64", "openharmony/arm64", "openharmony/amd64":
		return true
	}
	return false
}
